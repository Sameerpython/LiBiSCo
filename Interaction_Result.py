...
#####Start of Physicochemiocal tables###
def physicotable(dictname,colname):
    ...
    if bool(dictname):
        ...
        for k_all,v_all in dictname.iteritems():
    ...
    # initialization of second column
        ...
        print "<th  colspan='%d'> List of Residues</th>"% length_ofcell_all_H
        print "</tr>"
        ...
        print "No interaction is available"
...
#################
    if bool(graphdic1_All_H):
        ...
        All_H_graph_zipfilename=All_H_graph_filename+'.zip'
...
physicotable(All_graphdic_H,'col-2-3')
...
physicotable(common_graphdic_H,'col-2-3')
...
physicotable(All_graphdic_NonH,'col-2-3')
...
physicotable(common_graphdic_NonH,'col-2-3')
