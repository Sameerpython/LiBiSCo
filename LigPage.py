...
print "<form action='Interaction_Result.py' method = 'post' target = '_blank'>"
...
#For selection of Sub groups of Ligand

#print "<p>If you want to compare the sub groups of Ligands Please click below:</p>"
